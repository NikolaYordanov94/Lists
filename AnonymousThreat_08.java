    ...
    public static void main(String[] args) {
        ...
        while (!command.equals("3:1")){
            ...
            if(command.contains("merge")){
                ...
                int parts = Integer.parseInt(command.split(" ")[2]); // брой на частите на които делим нашия елемент
                ...
                texts.add(index, elementForDivide.substring(beginIndexOfText)); //ако не зададем краен идекс, крайния индекс става равен на последния
